...
SDP::SDPErrEnum SDP::openSDP(std::string &SDPFileName){
...
SDP::SDPErrEnum SDP::parseSDPFileHeader(std::shared_ptr<std::istream> inStream, SDPFileHeaderStruct &SDPFileHeader){
...
SDP::SDPErrEnum SDP::parseSDPFileInfo(std::shared_ptr<std::istream> inStream, SDPFileInfoStruct &SDPFileInfo){

    SDPFileInfo = {};

    //    //Check file header.
    if(parseSDPFileHeader(inStream, SDPFileInfo.SDPFileHeader) != SDP_NO_ERROR)
    ...
    while(true){
        ...
        SDPErrEnum retVal                             = parseSubContainerInfo(inStream, tmpSubContainerInfo);
