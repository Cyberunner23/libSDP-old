...
namespace libSDP{
    ...
    public:
        ...
        //Compress/Encrypt
        virtual uint64 processBuffer(uchar *unprocessedBuffer, uint64 unprocessedBufferSize, uchar *processedBuffer,
                                     uint64 expectedProcessedBufferSize, uint64 chunkNum);

        //Decompress/Decrypt
        virtual uint64 unprocessBuffer(uchar *processedBuffer, uint64 processedBufferSize, uchar *unprocessedBuffer,
                                       uint64 expectedUnprocessedBufferSize, uint64 chunkNum);
        ...
        virtual int setEncryptionKeyAndNonce(std::string encryptionKey, bool isEncryptionKeyInHex, std::string nonce,
                                             bool isNonceInHex);
