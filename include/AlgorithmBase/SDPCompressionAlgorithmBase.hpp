...
public:
    ...
    virtual uint64 decompress(uchar* compressedBuffer,   uchar* decompressedBuffer, uint64 compressedBufferSize,   uint64 decompressedDataSize,  uint64 chunkNum) = 0;
    virtual uint64 compress(uchar*   uncompressedBuffer, uchar* compressedBuffer,   uint64 uncompressedBufferSize, uint64 chunkNum) = 0;
