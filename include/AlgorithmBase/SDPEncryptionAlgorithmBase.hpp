...
namespace AlgorithmBase{
    ...
    public:
        ...
        virtual uint64 decryptBuffer(uchar *encryptedBuffer, uchar *decryptedBuffer, uint64 encryptedBufferSize,
                                     uint64 chunkNum)=0;

        virtual uint64 encryptBuffer(uchar *unencryptedBuffer, uchar *encryptedBuffer, uint64 unencryptedBufferSize,
                                     uint64 chunkNum)=0;
